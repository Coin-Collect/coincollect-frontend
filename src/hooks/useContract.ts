...
import {
  ...
  getCoinCollectClaimRewardV2Contract,
...
export const useCoinCollectClaimRewardV2Contract = () => {
  const { library } = useActiveWeb3React()
  return useMemo(() => getCoinCollectClaimRewardV2Contract(library.getSigner()), [library])
}
